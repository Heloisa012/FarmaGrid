    ...
    return Scaffold(
      floatingActionButton: Padding(
        ...
        child: FloatingActionButton.small(
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TelaSobreNos())),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text("Bem-vindo ao\nFarmaGrid+", textAlign: TextAlign.center, style: estiloTitulo),
                const SizedBox(height: 10),
                const Text("Sua saúde digital integrada",
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: "E-mail",
                            labelStyle: const TextStyle(color: corVerdeEscuro, fontWeight: FontWeight.bold),
                            suffixIcon: const Icon(Icons.email_outlined, color: corVerdeEscuro),
                            filled: true,
                            ...
                            focusedBorder: OutlineInputBorder(
                                ...
                                borderSide: const BorderSide(color: corVerdePrimario, width: 2)),
                        ...
                        TextButton(
                          onPressed: () => Navigator.push(
                              context, MaterialPageRoute(builder: (_) => TelaRecuperarSenha())),
                          child: const Text("Esqueceu sua senha?",
                              style: TextStyle(color: corVerdeEscuro, decoration: TextDecoration.underline)),
                        ),

                        const SizedBox(height: 6),
                        const Text("Entrar como:",
                            style: TextStyle(color: corVerdeEscuro, fontWeight: FontWeight.bold)),
                        const SizedBox(height: 10),

                        Row(
                          children: [
                            Expanded(child: _itemPerfil(Icons.person_outline, "Paciente")),
                            const SizedBox(width: 12),
                            Expanded(child: _itemPerfil(Icons.medical_services, "Médico/Clínica")),
                          ],
                        ),
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                          context, MaterialPageRoute(builder: (_) => TelaSelecaoCadastro())),
                      child: const Text("Cadastre-se",
                          style: TextStyle(color: corVerdeEscuro, fontWeight: FontWeight.bold, fontSize: 16)),
                    ),
                  ],
                ),
                const SizedBox(height: 16),
                GestureDetector(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TelaSobreNos())),
                  child: const Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.people_outline, color: Colors.white54, size: 15),
                      SizedBox(width: 5),
                      Text("Sobre Nós",
                          style: TextStyle(
  ...
  Widget _itemPerfil(IconData icone, String rotulo) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color: sel ? corVerdePrimario : Colors.grey.shade300, width: 2),
          borderRadius: BorderRadius.circular(15),
          color: sel ? corVerdePrimario.withValues(alpha: 0.1) : Colors.transparent,
        ),
        child: Column(
          children: [
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              const Text("Digite seu e-mail para receber o\ncódigo de recuperação",
                  textAlign: TextAlign.center,
                  style: TextStyle(color: Colors.white70, fontSize: 16)),
              const SizedBox(height: 30),
              Container(
                margin: const EdgeInsets.symmetric(horizontal: 30),
                padding: const EdgeInsets.all(25),
                decoration: BoxDecoration(color: corFundoClaro, borderRadius: BorderRadius.circular(30)),
                child: Form(
                  key: _key,
                  child: Column(
                    children: [
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: "E-mail",
                          labelStyle: const TextStyle(color: corVerdeEscuro, fontWeight: FontWeight.bold),
                          prefixIcon: const Icon(Icons.email_outlined, color: corVerdeEscuro),
                          filled: true,
                          fillColor: corVerdePrimario.withValues(alpha: 0.08),
                          border: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: BorderSide.none),
                          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: const BorderSide(color: corVerdePrimario, width: 2)),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                              ...
                              showDialog(
                                ...
                                builder: (_) => AlertDialog(
                                  ...
                                  title: const Row(children: [
                                    Icon(Icons.mark_email_read_outlined, color: corVerdePrimario),
                                    SizedBox(width: 8),
                                    Text("E-mail enviado!"),
                                  ]),
                                  content: const Text("Verifique sua caixa de entrada."),
                                  actions: [
                                    TextButton(
                                      child: const Text("OK", style: TextStyle(color: corVerdePrimario, fontWeight: FontWeight.bold)),
                          ...
                          child: const Text("Enviar Código", style: TextStyle(fontSize: 18, color: Colors.white)),
                        ),
                      ),
                      const SizedBox(height: 15),
                      TextButton.icon(
                        onPressed: () => Navigator.pop(context),
                        icon: const Icon(Icons.arrow_back, color: corVerdeEscuro),
                        label: const Text("Voltar", style: TextStyle(color: corVerdeEscuro, fontSize: 18)),
                      ),
                    ],
                  ),
                ),
